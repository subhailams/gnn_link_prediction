...
def evaluate_mrr(y_pred_pos, y_pred_neg):
    ...
    hits1000_list = (ranking_list <= 1000).to(torch.float)
    ...
    results = { "Hits@10": hits10_list.mean().item(),
                ...
                "Hits@1000": hits1000_list.mean().item(), 
...
def sample_level_hits(y_pred_pos, y_pred_neg):
    ...
    return {"Hits@20": hits20_list, "Hits@50": hits50_list, "Hits@100": hits100_list,"Hits@1000": hits1000_list}
