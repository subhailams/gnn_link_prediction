...
# from models.multi_link_transformer import LinkTransformer
...
def train_data(args, train_args, data, device, verbose=True):
    ...
    if args.save_as is not None:
        model_save_name = os.path.join(args.save_path,"checkpoints", args.data_name, args.save_as)
    else:
    ...
    if "citation" in data['dataset'] or data['dataset'] in ['pinterest','cora', 'citeseer', 'pubmed',  'chameleon', 'squirrel'] or args.heart:
